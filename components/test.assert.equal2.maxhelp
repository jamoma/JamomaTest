...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 437.0, 227.0, 32.5, 20.0 ],
					"text" : "* 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.0, 200.0, 405.0, 20.0 ],
					"text" : "test.assert.equal2 multiplication @input [1 2] [0 -5 123] @expected [2.] [0.]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 437.0, 161.0, 32.5, 20.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 437.0, 45.0, 105.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 52.0, 179.0, 48.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 446.5, 190.0, 433.5, 190.0, 433.5, 129.0, 446.5, 129.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 446.5, 256.0, 433.5, 256.0, 433.5, 195.0, 446.5, 195.0 ],
					"source" : [ "obj-17", 0 ]
				}
